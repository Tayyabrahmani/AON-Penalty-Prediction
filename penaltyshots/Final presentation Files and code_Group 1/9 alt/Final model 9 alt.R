...
apollo_fixed = c("asc_MC", "b_foot5","b_mvmtGK_cat5","b_ingameshoot_cat5","b_compleague_cat5","b_lastpenaltygoal_cat5","b_shothardness_cat5","b_tappedball_cat5","b_standposGK_cat5","b_GKmvmttyp_cat5","b_compQuali_cat5")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK_cat1*mvmtGK_cat + b_ingameshoot_cat1*ingameshoot_cat + b_compleague_cat1*compleague_cat + b_lastpenaltygoal_cat1*lastpenaltygoal_cat + b_shothardness_cat1*shothardness_cat + b_tappedball_cat1*tappedball_cat + b_standposGK_cat1*standposGK_cat + b_GKmvmttyp_cat1*GKmvmttyp_cat + b_compQuali_cat1*compQuali_cat 
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK_cat2*mvmtGK_cat + b_ingameshoot_cat2*ingameshoot_cat + b_compleague_cat2*compleague_cat + b_lastpenaltygoal_cat2*lastpenaltygoal_cat + b_shothardness_cat2*shothardness_cat + b_tappedball_cat2*tappedball_cat + b_standposGK_cat2*standposGK_cat + b_GKmvmttyp_cat2*GKmvmttyp_cat + b_compQuali_cat2*compQuali_cat 
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK_cat3*mvmtGK_cat + b_ingameshoot_cat3*ingameshoot_cat + b_compleague_cat3*compleague_cat + b_lastpenaltygoal_cat3*lastpenaltygoal_cat + b_shothardness_cat3*shothardness_cat + b_tappedball_cat3*tappedball_cat + b_standposGK_cat3*standposGK_cat + b_GKmvmttyp_cat3*GKmvmttyp_cat + b_compQuali_cat3*compQuali_cat 
  V[['ML']]  = asc_ML + b_foot4*foot_cat + b_mvmtGK_cat4*mvmtGK_cat + b_ingameshoot_cat4*ingameshoot_cat + b_compleague_cat4*compleague_cat + b_lastpenaltygoal_cat4*lastpenaltygoal_cat + b_shothardness_cat4*shothardness_cat + b_tappedball_cat4*tappedball_cat + b_standposGK_cat4*standposGK_cat + b_GKmvmttyp_cat4*GKmvmttyp_cat + b_compQuali_cat4*compQuali_cat 
  V[['MC']]  = asc_MC + b_foot5*foot_cat + b_mvmtGK_cat5*mvmtGK_cat + b_ingameshoot_cat5*ingameshoot_cat + b_compleague_cat5*compleague_cat + b_lastpenaltygoal_cat5*lastpenaltygoal_cat + b_shothardness_cat5*shothardness_cat + b_tappedball_cat5*tappedball_cat + b_standposGK_cat5*standposGK_cat + b_GKmvmttyp_cat5*GKmvmttyp_cat + b_compQuali_cat5*compQuali_cat 
  V[['MR']]  = asc_MR + b_foot6*foot_cat + b_mvmtGK_cat6*mvmtGK_cat + b_ingameshoot_cat6*ingameshoot_cat + b_compleague_cat6*compleague_cat + b_lastpenaltygoal_cat6*lastpenaltygoal_cat + b_shothardness_cat6*shothardness_cat + b_tappedball_cat6*tappedball_cat + b_standposGK_cat6*standposGK_cat + b_GKmvmttyp_cat6*GKmvmttyp_cat + b_compQuali_cat6*compQuali_cat 
  V[['DL']]  = asc_DL + b_foot7*foot_cat + b_mvmtGK_cat7*mvmtGK_cat + b_ingameshoot_cat7*ingameshoot_cat + b_compleague_cat7*compleague_cat + b_lastpenaltygoal_cat7*lastpenaltygoal_cat + b_shothardness_cat7*shothardness_cat + b_tappedball_cat7*tappedball_cat + b_standposGK_cat7*standposGK_cat + b_GKmvmttyp_cat7*GKmvmttyp_cat + b_compQuali_cat7*compQuali_cat 
...
TLpred = mean(forecast_final$TL) * 100
TLpred

TCpred = mean(forecast_final$TC) * 100
TCpred

TRpred = mean(forecast_final$TR) * 100
TRpred

DLpred = mean(forecast_final$DL) * 100
DLpred

DCpred = mean(forecast_final$DC) * 100
DCpred

DRpred = mean(forecast_final$DR) * 100
DRpred


#max(forecast_final[1])

typeof(forecast_final)

sapply(forecast_final, "[", 1) 


probNMwo3 <- forecast_final
red <- c(1,2,9)

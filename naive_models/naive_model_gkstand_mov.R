...
database = rename(database, "gk_stand" = "GK Stand", "sort_of_movement" = "Sort of Movement")

cols_to_select = c("gk_stand", "sort_of_movement")
cols_to_remove = c("gk_stand_central", "sort_of_movement_-")

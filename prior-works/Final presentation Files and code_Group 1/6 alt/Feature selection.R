...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot5", "b_mvmtGK5")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot5", "b_mvmtGK5","b_standposGK5")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot5", "b_mvmtGK5","b_standposGK5","b_ingameshoot5")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_clubornational4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_clubornational1*clubornational_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_clubornational2*clubornational_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_clubornational3*clubornational_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_clubornational4*clubornational_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_clubornational5*clubornational_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_clubornational6*clubornational_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_compNational4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_compNational1*compNational_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_compNational2*compNational_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_compNational3*compNational_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_compNational4*compNational_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_compNational5*compNational_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_compNational6*compNational_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_secondlastGKdivedir4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_secondlastGKdivedir1*secondlastGKdivedir_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_secondlastGKdivedir2*secondlastGKdivedir_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_secondlastGKdivedir3*secondlastGKdivedir_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_secondlastGKdivedir4*secondlastGKdivedir_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_secondlastGKdivedir5*secondlastGKdivedir_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_secondlastGKdivedir6*secondlastGKdivedir_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_heightGK4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_heightGK1*heightGK_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_heightGK2*heightGK_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_heightGK3*heightGK_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_heightGK4*heightGK_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_heightGK5*heightGK_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_heightGK6*heightGK_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_decider4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_decider1*decider_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_decider2*decider_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_decider3*decider_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_decider4*decider_cat 
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_decider5*decider_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_decider6*decider_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat
  ...
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_posdef4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_posdef1*posdef_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_posdef2*posdef_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_posdef3*posdef_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_posdef4*posdef_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_posdef5*posdef_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_posdef6*posdef_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_gameimportance4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_gameimportance1*gameimportance_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_gameimportance2*gameimportance_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_gameimportance3*gameimportance_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_gameimportance4*gameimportance_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_gameimportance5*gameimportance_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_gameimportance6*gameimportance_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_specialmatch4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_specialmatch1*specialmatch_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_specialmatch2*specialmatch_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_specialmatch3*specialmatch_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_specialmatch4*specialmatch_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_specialmatch5*specialmatch_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_specialmatch6*specialmatch_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_compCup4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_compCup1*compCup_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_compCup2*compCup_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_compCup3*compCup_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_compCup4*compCup_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_compCup5*compCup_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_compCup6*compCup_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_compECC4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_compECC1*compECC_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_compECC2*compECC_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_compECC3*compECC_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_compECC4*compECC_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_compECC5*compECC_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_compECC6*compECC_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_compQuali4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_compQuali1*compQuali_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_compQuali2*compQuali_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_compQuali3*compQuali_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_compQuali4*compQuali_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_compQuali5*compQuali_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_compQuali6*compQuali_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseygreyGK4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseygreyGK1*jerseygreyGK_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseygreyGK2*jerseygreyGK_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseygreyGK3*jerseygreyGK_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseygreyGK4*jerseygreyGK_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseygreyGK5*jerseygreyGK_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseygreyGK6*jerseygreyGK_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseyredGK4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseyredGK1*jerseyredGK_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseyredGK2*jerseyredGK_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseyredGK3*jerseyredGK_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseyredGK4*jerseyredGK_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseyredGK5*jerseyredGK_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseyredGK6*jerseyredGK_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseyblackGK4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseyblackGK1*jerseyblackGK_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseyblackGK2*jerseyblackGK_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseyblackGK3*jerseyblackGK_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseyblackGK4*jerseyblackGK_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseyblackGK5*jerseyblackGK_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseyblackGK6*jerseyblackGK_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseyblueGK4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseyblueGK1*jerseyblueGK_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseyblueGK2*jerseyblueGK_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseyblueGK3*jerseyblueGK_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseyblueGK4*jerseyblueGK_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseyblueGK5*jerseyblueGK_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseyblueGK6*jerseyblueGK_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseygreenGK4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseygreenGK1*jerseygreenGK_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseygreenGK2*jerseygreenGK_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseygreenGK3*jerseygreenGK_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseygreenGK4*jerseygreenGK_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseygreenGK5*jerseygreenGK_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseygreenGK6*jerseygreenGK_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseyyellowGK4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseyyellowGK1*jerseyyellowGK_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseyyellowGK2*jerseyyellowGK_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseyyellowGK3*jerseyyellowGK_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseyyellowGK4*jerseyyellowGK_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseyyellowGK5*jerseyyellowGK_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseyyellowGK6*jerseyyellowGK_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseyorangeGK4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseyorangeGK1*jerseyorangeGK_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseyorangeGK2*jerseyorangeGK_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseyorangeGK3*jerseyorangeGK_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseyorangeGK4*jerseyorangeGK_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseyorangeGK5*jerseyorangeGK_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseyorangeGK6*jerseyorangeGK_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseygoldPL4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseygoldPL1*jerseygoldPL_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseygoldPL2*jerseygoldPL_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseygoldPL3*jerseygoldPL_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseygoldPL4*jerseygoldPL_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseygoldPL5*jerseygoldPL_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseygoldPL6*jerseygoldPL_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseywhitePL4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseywhitePL1*jerseywhitePL_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseywhitePL2*jerseywhitePL_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseywhitePL3*jerseywhitePL_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseywhitePL4*jerseywhitePL_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseywhitePL5*jerseywhitePL_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseywhitePL6*jerseywhitePL_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseyblackPL4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseyblackPL1*jerseyblackPL_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseyblackPL2*jerseyblackPL_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseyblackPL3*jerseyblackPL_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseyblackPL4*jerseyblackPL_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseyblackPL5*jerseyblackPL_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseyblackPL6*jerseyblackPL_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseypinkPL4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseypinkPL1*jerseypinkPL_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseypinkPL2*jerseypinkPL_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseypinkPL3*jerseypinkPL_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseypinkPL4*jerseypinkPL_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseypinkPL5*jerseypinkPL_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseypinkPL6*jerseypinkPL_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseypurplePL4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseypurplePL1*jerseypurplePL_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseypurplePL2*jerseypurplePL_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseypurplePL3*jerseypurplePL_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseypurplePL4*jerseypurplePL_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseypurplePL5*jerseypurplePL_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseypurplePL6*jerseypurplePL_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseyredPL4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseyredPL1*jerseyredPL_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseyredPL2*jerseyredPL_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseyredPL3*jerseyredPL_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseyredPL4*jerseyredPL_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseyredPL5*jerseyredPL_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseyredPL6*jerseyredPL_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseygreenPL4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_jerseygreenPL1*jerseygreenPL_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseygreenPL2*jerseygreenPL_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseygreenPL3*jerseygreenPL_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseygreenPL4*jerseygreenPL_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseygreenPL5*jerseygreenPL_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseygreenPL6*jerseygreenPL_cat
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_jerseygreenPL4","b_secondlastpen4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_jerseygreenPL2*jerseygreenPL_cat + b_secondlastpen2*secondlastpen_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_jerseygreenPL3*jerseygreenPL_cat + b_secondlastpen3*secondlastpen_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_jerseygreenPL4*jerseygreenPL_cat + b_secondlastpen4*secondlastpen_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_jerseygreenPL5*jerseygreenPL_cat + b_secondlastpen5*secondlastpen_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_jerseygreenPL6*jerseygreenPL_cat + b_secondlastpen6*secondlastpen_cat
...
### Set core controls
apollo_control = list(
  modelName  ="Apollo_6_alt_model40",
  modelDescr ="Simple MNL model on penalty data1",
  indivID    = "ID"
)
...
### Vector with names (in quotes) of parameters to be kept fixed at their starting value in apollo_beta, use apollo_beta_fixed = c() if none
apollo_fixed = c("asc_DC", "b_foot4", "b_mvmtGK4","b_standposGK4","b_ingameshoot4","b_compleague4","b_lastpenaltygoal4","b_opplstpengoal4","b_shothardness4","b_tappedball4","b_roundnogroup4","b_GKmvmttyp4","b_secondlastpen4")
#apollo_fixed = c("asc_TC","b_foot2", "b_mvmtGK2", "b_standposGK2", "b_ingameshoot2","b_compleague2", "b_heightGK2", "b_decider2", "b_lastpenaltygoal2", "b_lastpenaldir2","b_saverateGK2", "b_opplstpengoal2","b_roundnogroup2", "b_posdef2", "b_GKmvmttyp2")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[['TL']]  = asc_TL + b_foot1*foot_cat + b_mvmtGK1*mvmtGK_cat + b_standposGK1*standposGK_cat + b_ingameshoot1*ingameshoot_cat + b_compleague1*compleague_cat + b_lastpenaltygoal1*lastpenaltygoal_cat + b_opplstpengoal1*opplstpengoal_cat + b_shothardness1*shothardness_cat + b_tappedball1*tappedball_cat + b_roundnogroup1*roundnogroup_cat + b_GKmvmttyp1*GKmvmttyp_cat + b_secondlastpen1*secondlastpen_cat
  V[['TC']]  = asc_TC + b_foot2*foot_cat + b_mvmtGK2*mvmtGK_cat + b_standposGK2*standposGK_cat + b_ingameshoot2*ingameshoot_cat + b_compleague2*compleague_cat + b_lastpenaltygoal2*lastpenaltygoal_cat + b_opplstpengoal2*opplstpengoal_cat + b_shothardness2*shothardness_cat + b_tappedball2*tappedball_cat + b_roundnogroup2*roundnogroup_cat + b_GKmvmttyp2*GKmvmttyp_cat + b_secondlastpen2*secondlastpen_cat
  V[['TR']]  = asc_TR + b_foot3*foot_cat + b_mvmtGK3*mvmtGK_cat + b_standposGK3*standposGK_cat + b_ingameshoot3*ingameshoot_cat + b_compleague3*compleague_cat + b_lastpenaltygoal3*lastpenaltygoal_cat + b_opplstpengoal3*opplstpengoal_cat + b_shothardness3*shothardness_cat + b_tappedball3*tappedball_cat + b_roundnogroup3*roundnogroup_cat + b_GKmvmttyp3*GKmvmttyp_cat + b_secondlastpen3*secondlastpen_cat
  V[['DL']]  = asc_DL + b_foot4*foot_cat + b_mvmtGK4*mvmtGK_cat + b_standposGK4*standposGK_cat + b_ingameshoot4*ingameshoot_cat + b_compleague4*compleague_cat + b_lastpenaltygoal4*lastpenaltygoal_cat + b_opplstpengoal4*opplstpengoal_cat + b_shothardness4*shothardness_cat + b_tappedball4*tappedball_cat + b_roundnogroup4*roundnogroup_cat + b_GKmvmttyp4*GKmvmttyp_cat + b_secondlastpen4*secondlastpen_cat
  V[['DC']]  = asc_DC + b_foot5*foot_cat + b_mvmtGK5*mvmtGK_cat + b_standposGK5*standposGK_cat + b_ingameshoot5*ingameshoot_cat + b_compleague5*compleague_cat + b_lastpenaltygoal5*lastpenaltygoal_cat + b_opplstpengoal5*opplstpengoal_cat + b_shothardness5*shothardness_cat + b_tappedball5*tappedball_cat + b_roundnogroup5*roundnogroup_cat + b_GKmvmttyp5*GKmvmttyp_cat + b_secondlastpen5*secondlastpen_cat
  V[['DR']]  = asc_DR + b_foot6*foot_cat + b_mvmtGK6*mvmtGK_cat + b_standposGK6*standposGK_cat + b_ingameshoot6*ingameshoot_cat + b_compleague6*compleague_cat + b_lastpenaltygoal6*lastpenaltygoal_cat + b_opplstpengoal6*opplstpengoal_cat + b_shothardness6*shothardness_cat + b_tappedball6*tappedball_cat + b_roundnogroup6*roundnogroup_cat + b_GKmvmttyp6*GKmvmttyp_cat + b_secondlastpen6*secondlastpen_cat
...
model40 = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

apollo_modelOutput(model40)

forecast39 = apollo_prediction(model40,
                               apollo_probabilities,
                               apollo_inputs)
apollo_saveOutput(model40)

#Log Likelihood ratio test 
apollo_lrTest(model19, model40)